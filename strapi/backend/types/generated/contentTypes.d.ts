...
export interface ApiApproachPageApproachPage
  extends Struct.CollectionTypeSchema {
...
export interface ApiInquiryInquiry extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    TypeOfTreatment: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
  ...
  attributes: {
    About: Schema.Attribute.DynamicZone<
      [
        ...
        'diffrence.diffrence',
        'visible-results-about.visible-results-about',
      ]
    >;
    approach: Schema.Attribute.DynamicZone<
      ['approach.approach', 'what-to-expect.what-to-expect']
    >;
    Contact: Schema.Attribute.DynamicZone<['contact-page.contact-page']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    event: Schema.Attribute.DynamicZone<['event.event']>;
    landing: Schema.Attribute.DynamicZone<
      [
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::page.page'> &
      Schema.Attribute.Private;
    Media: Schema.Attribute.DynamicZone<['media-part.media-part']>;
    message: Schema.Attribute.DynamicZone<['message-page.message-page']>;
    publishedAt: Schema.Attribute.DateTime;
    team: Schema.Attribute.DynamicZone<['our-team-section.our-team-section']>;
    Treatments: Schema.Attribute.DynamicZone<['treatments.treatments']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
